...
class SchoolProviderApi implements SchoolProviderContract {
  SchoolProviderApi();
  ...
  Future<ApiResponse> getNewerThan(DateTime date) async {
    final QueryBuilder<School> query = QueryBuilder<School>(School())
      ..whereGreaterThan(keyVarCreatedAt, date);
    return getApiResponse<School>(await query.query());
  }
